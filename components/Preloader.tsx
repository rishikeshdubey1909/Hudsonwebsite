    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <span className="bg-gradient-to-r from-orange-400 via-accent to-orange-400 bg-clip-text text-transparent">
              Group
            </span>
          </motion.h2>
        ...
        <div className="w-64 sm:w-80 h-1 bg-text/10 rounded-full overflow-hidden mb-4">
          <motion.div
            className="h-full bg-gradient-to-r from-accent via-orange-400 to-accent rounded-full"
            initial={{ width: 0 }}
