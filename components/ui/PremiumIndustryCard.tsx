...
interface PremiumIndustryCardProps {
  icon: string
  title: string
  bullets: string[]
  href: string
...
function PremiumIndustryCard({ icon, title, bullets, href, delay = 0 }: PremiumIndustryCardProps) {
      ...
      <Link href={href} className="block h-full">
        ...
        >
          ...
          <div className="relative px-8 pt-12 pb-10 bg-gradient-to-br from-accent/4 via-accent/2 to-transparent backdrop-blur-[2px]">
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Icon container */}
                <motion.div
                  className="relative w-20 h-20 rounded-full bg-gradient-to-br from-accent/12 to-accent/6 border border-accent/20 flex items-center justify-center backdrop-blur-md shadow-[0_4px_12px_rgba(240,90,40,0.1)]"
                  animate={isHovered ? { 
                    boxShadow: '0 0 32px rgba(240, 90, 40, 0.25), 0 4px 16px rgba(240, 90, 40, 0.15)',
                    borderColor: 'rgba(240, 90, 40, 0.3)',
                    scale: 1.05
                  } : {}}
          ...
          <div className="px-8 pb-12 pt-8">
            {/* Title */}
            <h3 className="text-2xl lg:text-3xl font-bold mb-10 text-dark tracking-[-0.02em] leading-tight">
              {title}
            </h3>
            ...
            <ul className="space-y-5 mb-12">
              {bullets.map((bullet, bulletIndex) => (
                ...
                >
                  ...
                  <span className="text-text/70 leading-relaxed text-[15px] lg:text-base flex-1 pt-0.5">
                    {bullet}
                  </span>
                </motion.li>
              ))}
...
export default memo(PremiumIndustryCard)
