...
function Hero() {
  ...
  useEffect(() => {
    ...
    gsap.set([badge, heading, description, cta], { opacity: 0, y: 30, force3D: true })
    gsap.set(stats, { opacity: 0, scale: 0.8, y: 20, force3D: true })

    // Animate in sequence with GPU acceleration
    tl.to(badge, { opacity: 1, y: 0, duration: 0.6, force3D: true }, 0.2)
      .to(heading, { opacity: 1, y: 0, duration: 0.8, force3D: true }, 0.3)
      .to(description, { opacity: 1, y: 0, duration: 0.8, force3D: true }, 0.5)
      .to(cta, { opacity: 1, y: 0, duration: 0.8, force3D: true }, 0.7)
      .to(stats, { 
        opacity: 1, 
        scale: 1, 
        y: 0, 
