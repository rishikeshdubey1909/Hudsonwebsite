...
const softwareServices = [
  ...
  },
  {
    ...
    icon: '🌐',
    gradient: 'from-primary/40 via-accent/20 to-primary/40',
  ...
  },
  {
    ...
    icon: '🏢',
    gradient: 'from-primary/70 to-accent/90',
  ...
  },
  {
    ...
    icon: '💡',
    gradient: 'from-accent/80 via-primary/50 to-accent/80',
  ...
  },
  {
    ...
    icon: '🏗️',
    gradient: 'from-primary/30 via-accent/15 to-primary/30',
