...
const hudsonPrinciples = [
  ...
  },
  {
    ...
    gradient: 'from-accent/60 via-primary/40 to-accent/60',
  },
  {
    letter: 'O',
  ...
  },
  {
    ...
    gradient: 'from-accent/70 via-primary/30 to-accent/70',
  },
]
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-accent/10 via-primary/5 to-secondary/10">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(240,90,40,0.1),transparent_50%)]" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
          ...
          <div className="relative">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-6 mb-12">
              ...
              >
                <div className="relative h-full bg-gradient-to-br from-accent/5 via-white to-primary/5 rounded-3xl p-8 lg:p-10 border-2 border-accent/20 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className="absolute top-6 right-6 w-20 h-20 lg:w-24 lg:h-24">
                    <div className="relative w-full h-full">
                      <div className="absolute inset-0 bg-gradient-to-br from-accent to-primary rounded-2xl rotate-12 group-hover:rotate-6 transition-transform duration-500 shadow-xl" />
                      <div className="absolute inset-0 bg-gradient-to-br from-accent/80 to-primary/80 rounded-2xl -rotate-6 group-hover:-rotate-12 transition-transform duration-500 flex items-center justify-center">
                  ...
                  <div className="relative z-10 pr-20 lg:pr-24">
                    ...
                    <h3 className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent">
                      HudsonIT Consultancy Ltd
                    </h3>
              ...
              >
                <div className="relative h-full bg-gradient-to-br from-primary/5 via-white to-accent/5 rounded-3xl p-8 lg:p-10 border-2 border-primary/20 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden">
                  {/* Animated Background Gradient */}
                  ...
                  <div className="absolute top-6 right-6 w-20 h-20 lg:w-24 lg:h-24">
                    <div className="relative w-full h-full">
                      <div className="absolute inset-0 bg-gradient-to-br from-primary to-accent rounded-2xl -rotate-12 group-hover:-rotate-6 transition-transform duration-500 shadow-xl" />
                      <div className="absolute inset-0 bg-gradient-to-br from-primary/80 to-accent/80 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform duration-500 flex items-center justify-center">
                        <span className="text-4xl">👥</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 pr-20 lg:pr-24">
                    <div className="inline-block mb-4">
                      <span className="px-4 py-1.5 rounded-full bg-primary/20 text-primary font-semibold text-xs uppercase tracking-wide">
                        Global Recruitment
                      </span>
                    </div>
                    <h3 className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                      Hudson Manpower Inc
                    </h3>
      ...
      <section className="relative py-24 bg-gradient-to-b from-white via-light/20 to-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(240,90,40,0.05),transparent_50%)]" />
      ...
      <section className="relative py-32 bg-gradient-to-b from-white via-light/30 to-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
              ...
              >
                <div className="relative h-full bg-white rounded-3xl p-8 lg:p-10 border-2 border-gray-200/50 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${
                    index === 0 
                      ? 'from-accent/10 via-primary/5 to-transparent' 
                  ...
                  <div className="relative mb-8">
                    ...
                    >
                      ...
                      <motion.div
                        className={`absolute inset-0 rounded-3xl border-4 ${
                          index === 0 ? 'border-accent/50' : 'border-primary/50'
                        }`}
                        animate={{
                          scale: [1, 1.3, 1],
                          opacity: [0.5, 0, 0.5],
                    ...
                    {index === 0 && (
                      <div className="hidden lg:block absolute top-1/2 -right-6 w-12 h-1 z-10">
                        ...
                        />
                        <motion.div
                          className="absolute -right-2 top-1/2 -translate-y-1/2 w-4 h-4 bg-gradient-to-r from-accent to-primary rounded-full"
                          initial={{ scale: 0 }}
                          whileInView={{ scale: 1 }}
                          viewport={{ once: true }}
                          transition={{ delay: 0.6, type: "spring", stiffness: 200 }}
          ...
          >
            <div className="relative bg-gradient-to-br from-white via-light/50 to-white rounded-3xl p-10 lg:p-16 border-2 border-gray-200/50 shadow-2xl overflow-hidden">
              ...
              {/* Gradient Overlays */}
              <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-accent/10 via-primary/10 to-transparent rounded-full blur-3xl" />
              <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-primary/10 via-accent/10 to-transparent rounded-full blur-3xl" />
