...
const INDUSTRIES_DATA = [
  {
    ...
    category: 'Energy',
    image: 'https://images.unsplash.com/photo-1621451537084-482c73073a0f?w=1200&q=90&auto=format&fit=crop',
    hasImage: true,
            ...
            >
              ...
              {INDUSTRIES_DATA.slice(0, 8).map((industry, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-accent to-primary flex items-center justify-center shadow-2xl border-2 border-accent/30">
                      <span className="text-4xl filter drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 8px rgba(240, 90, 40, 0.5))' }}>{industry.icon}</span>
                    </div>
                    <AnimatePresence>
              ...
              >
                <span className="text-6xl filter drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 10px rgba(240, 90, 40, 0.6))' }}>🌍</span>
              </motion.div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative py-32 bg-gradient-to-b from-white via-secondary to-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
          ...
          >
            ...
            <p className="text-2xl text-primary/80 max-w-3xl mx-auto">
              ...
              return (
                ...
                >
                  <div className={`relative h-full bg-white rounded-3xl border-2 border-secondary hover:border-accent/50 overflow-hidden transition-all duration-500 shadow-lg hover:shadow-xl ${
                    ...
                    {industry.hasImage && industry.image ? (
                      <div className="relative h-64 overflow-hidden">
                        ...
                        <div className="absolute bottom-4 right-4">
                          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-accent to-primary flex items-center justify-center shadow-2xl border-2 border-accent/30">
                            <span className="text-3xl filter drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 6px rgba(240, 90, 40, 0.5))' }}>{industry.icon}</span>
                          </div>
                        </div>
                      </div>
                    ) : (
                      <div className="relative h-64 overflow-hidden bg-gradient-to-br from-accent/20 via-primary/10 to-accent/20">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-32 h-32 rounded-3xl bg-gradient-to-br from-accent to-primary flex items-center justify-center shadow-2xl border-4 border-white/50 group-hover:scale-110 transition-transform duration-500">
                            <span className="text-6xl filter drop-shadow-lg" style={{ filter: 'drop-shadow(0 0 10px rgba(240, 90, 40, 0.6))' }}>{industry.icon}</span>
                          </div>
                        </div>
                    ...
                    <div className="p-8">
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                {industry.keyRoles.map((role, idx) => (
                                  <div key={idx} className="flex items-center gap-2 text-sm text-primary/80">
                      ...
                      {industry.href && (
                        <Link
                          href={industry.href}
                          className="mt-4 block w-full py-3 rounded-xl font-semibold text-center transition-all duration-300 bg-gradient-to-r from-accent to-primary text-white hover:shadow-xl hover:scale-105"
                        >
